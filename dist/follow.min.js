...
var FollowDefaults = /** @class */ (function () {
    ...
    Follow.animate = function (context) {
        for (var _i = 0, _a = context.elements; _i < _a.length; _i++) {
            var element = _a[_i];
            var additional = new FollowPosition(parseFloat(((context.mouse.x + context.scroll.x - element.position.x) / element.factor).toString()), parseFloat(((context.mouse.y + context.scroll.y - element.position.y) / element.factor).toString()));
